 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu Jul 11 17:18:54 2019
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME solver_51_v2
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void solver_51_v2_Outputs_wrapper(const real_T *u0,
			const real_T *u1,
			const real_T *u2,
			const real_T *u3,
			const real_T *u4,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    solver_51_v2_Outputs_wrapper(u0, u1, u2, u3, u4, u5, u6, y0, y1);
