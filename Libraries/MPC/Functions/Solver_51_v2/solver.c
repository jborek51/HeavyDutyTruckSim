/* Produced by CVXGEN, 2019-07-11 08:31:51 -0400.  */
...
void setup_indexed_params(void) {
  ...
  /* is undefined. */
  params.lam_b[1] = params.lam_b_1;
  params.lam_b[2] = params.lam_b_2;
  params.lam_b[3] = params.lam_b_3;
  params.lam_b[4] = params.lam_b_4;
  params.lam_b[5] = params.lam_b_5;
  params.lam_b[6] = params.lam_b_6;
  params.lam_b[7] = params.lam_b_7;
  params.lam_b[8] = params.lam_b_8;
  params.lam_b[9] = params.lam_b_9;
  params.lam_b[10] = params.lam_b_10;
  params.lam_b[11] = params.lam_b_11;
  params.lam_b[12] = params.lam_b_12;
  params.lam_b[13] = params.lam_b_13;
  params.lam_b[14] = params.lam_b_14;
  params.lam_b[15] = params.lam_b_15;
  params.lam_b[16] = params.lam_b_16;
  params.lam_b[17] = params.lam_b_17;
  params.lam_b[18] = params.lam_b_18;
  params.lam_b[19] = params.lam_b_19;
  params.lam_b[20] = params.lam_b_20;
  params.lam_b[21] = params.lam_b_21;
  params.lam_b[22] = params.lam_b_22;
  params.lam_b[23] = params.lam_b_23;
  params.lam_b[24] = params.lam_b_24;
  params.lam_b[25] = params.lam_b_25;
  params.lam_b[26] = params.lam_b_26;
  params.lam_b[27] = params.lam_b_27;
  params.lam_b[28] = params.lam_b_28;
  params.lam_b[29] = params.lam_b_29;
  params.lam_b[30] = params.lam_b_30;
  params.lam_b[31] = params.lam_b_31;
  params.lam_b[32] = params.lam_b_32;
  params.lam_b[33] = params.lam_b_33;
  params.lam_b[34] = params.lam_b_34;
  params.lam_b[35] = params.lam_b_35;
  params.lam_b[36] = params.lam_b_36;
  params.lam_b[37] = params.lam_b_37;
  params.lam_b[38] = params.lam_b_38;
  params.lam_b[39] = params.lam_b_39;
  params.lam_b[40] = params.lam_b_40;
  params.lam_b[41] = params.lam_b_41;
  params.lam_b[42] = params.lam_b_42;
  params.lam_b[43] = params.lam_b_43;
  params.lam_b[44] = params.lam_b_44;
  params.lam_b[45] = params.lam_b_45;
  params.lam_b[46] = params.lam_b_46;
  params.lam_b[47] = params.lam_b_47;
  params.lam_b[48] = params.lam_b_48;
  params.lam_b[49] = params.lam_b_49;
  params.lam_b[50] = params.lam_b_50;
  params.lam_b[51] = params.lam_b_51;
  params.lam_e[1] = params.lam_e_1;
  params.KE_des[1] = params.KE_des_1;
  params.lam_e[2] = params.lam_e_2;
  params.KE_des[2] = params.KE_des_2;
  params.lam_e[3] = params.lam_e_3;
  params.KE_des[3] = params.KE_des_3;
  params.lam_e[4] = params.lam_e_4;
  params.KE_des[4] = params.KE_des_4;
  params.lam_e[5] = params.lam_e_5;
  params.KE_des[5] = params.KE_des_5;
  params.lam_e[6] = params.lam_e_6;
  params.KE_des[6] = params.KE_des_6;
  params.lam_e[7] = params.lam_e_7;
  params.KE_des[7] = params.KE_des_7;
  params.lam_e[8] = params.lam_e_8;
  params.KE_des[8] = params.KE_des_8;
  params.lam_e[9] = params.lam_e_9;
  params.KE_des[9] = params.KE_des_9;
  params.lam_e[10] = params.lam_e_10;
  params.KE_des[10] = params.KE_des_10;
  params.lam_e[11] = params.lam_e_11;
  params.KE_des[11] = params.KE_des_11;
  params.lam_e[12] = params.lam_e_12;
  params.KE_des[12] = params.KE_des_12;
  params.lam_e[13] = params.lam_e_13;
  params.KE_des[13] = params.KE_des_13;
  params.lam_e[14] = params.lam_e_14;
  params.KE_des[14] = params.KE_des_14;
  params.lam_e[15] = params.lam_e_15;
  params.KE_des[15] = params.KE_des_15;
  params.lam_e[16] = params.lam_e_16;
  params.KE_des[16] = params.KE_des_16;
  params.lam_e[17] = params.lam_e_17;
  params.KE_des[17] = params.KE_des_17;
  params.lam_e[18] = params.lam_e_18;
  params.KE_des[18] = params.KE_des_18;
  params.lam_e[19] = params.lam_e_19;
  params.KE_des[19] = params.KE_des_19;
  params.lam_e[20] = params.lam_e_20;
  params.KE_des[20] = params.KE_des_20;
  params.lam_e[21] = params.lam_e_21;
  params.KE_des[21] = params.KE_des_21;
  params.lam_e[22] = params.lam_e_22;
  params.KE_des[22] = params.KE_des_22;
  params.lam_e[23] = params.lam_e_23;
  params.KE_des[23] = params.KE_des_23;
  params.lam_e[24] = params.lam_e_24;
  params.KE_des[24] = params.KE_des_24;
  params.lam_e[25] = params.lam_e_25;
  params.KE_des[25] = params.KE_des_25;
  params.lam_e[26] = params.lam_e_26;
  params.KE_des[26] = params.KE_des_26;
  params.lam_e[27] = params.lam_e_27;
  params.KE_des[27] = params.KE_des_27;
  params.lam_e[28] = params.lam_e_28;
  params.KE_des[28] = params.KE_des_28;
  params.lam_e[29] = params.lam_e_29;
  params.KE_des[29] = params.KE_des_29;
  params.lam_e[30] = params.lam_e_30;
  params.KE_des[30] = params.KE_des_30;
  params.lam_e[31] = params.lam_e_31;
  params.KE_des[31] = params.KE_des_31;
  params.lam_e[32] = params.lam_e_32;
  params.KE_des[32] = params.KE_des_32;
  params.lam_e[33] = params.lam_e_33;
  params.KE_des[33] = params.KE_des_33;
  params.lam_e[34] = params.lam_e_34;
  params.KE_des[34] = params.KE_des_34;
  params.lam_e[35] = params.lam_e_35;
  params.KE_des[35] = params.KE_des_35;
  params.lam_e[36] = params.lam_e_36;
  params.KE_des[36] = params.KE_des_36;
  params.lam_e[37] = params.lam_e_37;
  params.KE_des[37] = params.KE_des_37;
  params.lam_e[38] = params.lam_e_38;
  params.KE_des[38] = params.KE_des_38;
  params.lam_e[39] = params.lam_e_39;
  params.KE_des[39] = params.KE_des_39;
  params.lam_e[40] = params.lam_e_40;
  params.KE_des[40] = params.KE_des_40;
  params.lam_e[41] = params.lam_e_41;
  params.KE_des[41] = params.KE_des_41;
  params.lam_e[42] = params.lam_e_42;
  params.KE_des[42] = params.KE_des_42;
  params.lam_e[43] = params.lam_e_43;
  params.KE_des[43] = params.KE_des_43;
  params.lam_e[44] = params.lam_e_44;
  params.KE_des[44] = params.KE_des_44;
  params.lam_e[45] = params.lam_e_45;
  params.KE_des[45] = params.KE_des_45;
  params.lam_e[46] = params.lam_e_46;
  params.KE_des[46] = params.KE_des_46;
  params.lam_e[47] = params.lam_e_47;
  params.KE_des[47] = params.KE_des_47;
  params.lam_e[48] = params.lam_e_48;
  params.KE_des[48] = params.KE_des_48;
  params.lam_e[49] = params.lam_e_49;
  params.KE_des[49] = params.KE_des_49;
  params.lam_e[50] = params.lam_e_50;
  params.KE_des[50] = params.KE_des_50;
  params.lam_e[51] = params.lam_e_51;
...
double eval_objv(void) {
  ...
  objv += work.quad_226401624064[0]+work.quad_462507278336[0]+work.quad_259068092416[0]+work.quad_668622508032[0]+work.quad_105355575296[0]+work.quad_281467015168[0]+work.quad_756213379072[0]+work.quad_17661059072[0]+work.quad_554530824192[0]+work.quad_828449910784[0]+work.quad_38409555968[0]+work.quad_136758996992[0]+work.quad_987113906176[0]+work.quad_892036550656[0]+work.quad_507159662592[0]+work.quad_861286477824[0]+work.quad_131187154944[0]+work.quad_26748923904[0]+work.quad_581111574528[0]+work.quad_566303748096[0]+work.quad_984127086592[0]+work.quad_144826572800[0]+work.quad_990115905536[0]+work.quad_231474102272[0]+work.quad_874468802560[0]+work.quad_911124606976[0]+work.quad_317464064000[0]+work.quad_571423891456[0]+work.quad_845124456448[0]+work.quad_414667886592[0]+work.quad_562415247360[0]+work.quad_403004809216[0]+work.quad_914939170816[0]+work.quad_105021247488[0]+work.quad_850444926976[0]+work.quad_460649287680[0]+work.quad_755892858880[0]+work.quad_648937607168[0]+work.quad_54190485504[0]+work.quad_825974534144[0]+work.quad_634809778176[0]+work.quad_764285628416[0]+work.quad_145657675776[0]+work.quad_102144540672[0]+work.quad_179851964416[0]+work.quad_981034192896[0]+work.quad_340776472576[0]+work.quad_822305083392[0]+work.quad_120128712704[0]+work.quad_780096086016[0]+work.quad_483630018560[0];
  return objv;
}
